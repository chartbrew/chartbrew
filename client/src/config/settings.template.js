export const API_HOST = import.meta.env.PROD
  ...
  : (import.meta.env.REACT_APP_API_HOST_DEV || "http://localhost:4019");

export const SITE_HOST = import.meta.env.PROD
  ? import.meta.env.REACT_APP_CLIENT_HOST
  : (import.meta.env.REACT_APP_CLIENT_HOST_DEV || "http://localhost:4018");
...
export const ONE_ACCOUNT_ENABLED = !!import.meta.env.REACT_APP_ONE_ACCOUNT_EXTERNAL_ID;
