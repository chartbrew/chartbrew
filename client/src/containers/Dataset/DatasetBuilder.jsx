...
import { LuCircleCheck, LuInfo, LuBrainCircuit, LuCircleX } from "react-icons/lu";
...
function DatasetBuilder(props) {
  ...
  const _onChangeGlobalSettings = ({
    ...
    const tempChart = {
      ...
      dashedLastPoint: typeof dashedLastPoint !== "undefined" ? dashedLastPoint : chart.dashedLastPoint,
    };
  ...
  return (
    <div className="grid grid-cols-12 divide-x dark:divide-x-0 divide-content3 gap-4 mt-4">
      <div className="col-span-12 md:col-span-4 bg-surface rounded-lg border border-divider p-4">
        <Autocomplete
