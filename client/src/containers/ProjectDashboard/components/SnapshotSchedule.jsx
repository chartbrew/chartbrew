...
function SnapshotSchedule({ isOpen, onClose }) {
  ...
  }, [isOpen, project?.id, project?.timezone, project?.snapshotSchedule]);
  ...
  const _resetSchedule = () => {
    setSchedule({
      ...
      daysOfWeek: project.snapshotSchedule?.daysOfWeek || undefined,
  ...
  const _onSave = async () => {
    setIsLoading(true);
    const { timezone, ...snapshotScheduleData } = schedule;
    const snapshotSchedule = _prepareScheduleForSave(snapshotScheduleData);
              ...
              <div className="flex flex-row items-center gap-2">
                <div className="flex flex-col gap-1 w-full">
                  ...
                  <div className="text-xs text-gray-500">
                    Changing this will also update the dashboard timezone.
                  </div>
                </div>
