...
/*
  Description
*/
class PostgresQueryBuilder extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const {
      savedQuery, savingQuery, updatingSavedQuery, testFailed, savingQueryError,
      queryUpdateError, queryUpdated, saveQueryModal, savedQuerySummary,
    } = this.state;
    const {
      ...
      <div style={styles.container}>
        <Grid columns={2} stackable centered divided>
          <Grid.Column width={8}>
            <Form>
              <Form.Field>
                <Header size="small">{"Enter your PostgreSQL query here"}</Header>
                <AceEditor
                  mode="pgsql"
                  theme="tomorrow"
                  height="400px"
                ...
                {testFailed
                  ...
                  <Message>
                    ...
                    <p>
                      ...
                      {" Refer to the "}
                      <a href="https://www.postgresql.org/docs/10/static/sql.html" target="_blank" rel="noopener noreferrer">
                        PostgreSQL documentation for help.
                      </a>
                    </p>
                  </Message>
                  )}
...
PostgresQueryBuilder.defaultProps = {
  onChangeQuery: () => {},
  testSuccess: false,
  testError: false,
  testingQuery: false,
...
PostgresQueryBuilder.propTypes = {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PostgresQueryBuilder));
